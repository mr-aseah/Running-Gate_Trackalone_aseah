...
* **Chronological Events** is a newest-first, independently scrolling audit view of accepted, duplicate, unknown, malformed, and post-completion RFID outcomes. An extra scan after completion is retained in the raw audit and labelled **EXTRA SCAN AFTER DONE — REVIEW**; it never creates another official lap.
